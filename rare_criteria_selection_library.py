...
def select_highest_von_mises_from_components(df: pd.DataFrame, 
                                             k: int = 1, 
                                             required_cols=None,
                                             min_size=1):
...
def select_highest_scalar(df: pd.DataFrame, required_cols: str, k: int = 1, min_size=1):
    col = required_cols
...
def select_highest_norm_3x3_tensor(df: pd.DataFrame, k: int = 1, required_cols=None, min_size=1):
    if required_cols is None:
        required_cols = ["t11_mean_mean", "t12_mean_mean", "t13_mean_mean",
                         "t21_mean_mean", "t22_mean_mean", "t23_mean_mean",
                         "t31_mean_mean", "t32_mean_mean", "t33_mean_mean"]
    ...
    t11, t12, t13, t21, t22, t23, t31, t32, t33 = (d[c].to_numpy(dtype=float) for c in required_cols)

    norm = np.sqrt(t11**2 + t12**2 + t13**2 + t21**2 + t22**2 + t23**2 + t31**2 + t32**2 + t33**2)
